...
namespace LoginServer.Utils
{
    public class EloRatings
    {
        ...
        */
        ...
        public EloRatings(double ratingA, double ratingB, double scoreA, double scoreB)
        {
        ...
        */
        ...
        public EloRatings SetNewSettings(double ratingA, double ratingB, double scoreA, double scoreB)
        {
            _ratingA = ratingA;
            _ratingB = ratingB;
            _scoreA = scoreA;
        ...
        */
        ...
        {
            double newRatingA = ratingA + (EloRatings.KFACTOR * (scoreA - expectedA));
            double newRatingB = ratingB + (EloRatings.KFACTOR * (scoreB - expectedB));
